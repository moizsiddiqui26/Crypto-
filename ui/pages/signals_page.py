...
def render_signals(df):
    ...
    # ==========================================
    # 📊 EXTRA: TREND STRENGTH VISUAL
    # ==========================================
    if "Bullish" in result["trend"]:
        st.success("🚀 Momentum is currently supporting an upward move.")
    elif "Bearish" in result["trend"]:
        st.error("📉 Momentum suggests potential further downside.")
    else:
        st.warning("⚖️ Market is currently in a consolidation phase.")
